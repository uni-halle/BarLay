...
#define INC_2OPT_LOCAL_SEARCH_1_CUH
...
namespace barcode_layout {
     ...
     */
    __global__ void find_best_swap_partner_v2(
    ...
    public:
        ...
        local_search_dev_2(const std::vector<synthesis_schedule> &schedules,
    ...
    bool local_search_dev_2::verbose = false;
}

#endif //INC_2OPT_LOCAL_SEARCH_1_CUH
